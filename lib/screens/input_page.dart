...
import 'package:flutterapp/screens/results_page.dart';
import 'package:flutterapp/components/round_icon_button.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:flutterapp/constant.dart';
import 'package:flutterapp/components/bottom_button.dart';
import 'package:flutterapp/components/icon_content.dart';
import 'package:flutterapp/calculator_brain.dart';
...
//  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Body Mask Index CALCULATOR'),
      ),
      body: Column(
